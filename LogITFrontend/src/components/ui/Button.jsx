const Button = ({
  ...
  const variants = {
    primary:
      "bg-purple-600 text-white hover:bg-purple-700 focus:ring-purple-400 active:scale-95",
    secondary:
      "bg-gray-200 text-gray-900 hover:bg-gray-300 focus:ring-gray-400",
    outline:
      "border-2 border-purple-600 bg-transparent text-purple-600 hover:bg-purple-50 focus:ring-purple-400",
    ghost: "bg-transparent hover:bg-gray-100 text-gray-700 focus:ring-gray-400",
    danger:
      "bg-red-600 text-white hover:bg-red-700 focus:ring-red-400 active:scale-95",
    success:
      "bg-green-600 text-white hover:bg-green-700 focus:ring-green-400 active:scale-95",
  };
